...
class CollectionsTest:
  ...
  @Test def linerSequence(): Unit =
    ...
    val listMutable = measures("List Buffer Immutable")(range.to(mutable.ListBuffer))(_.last)(_.appended(value))(_.dropWhile(_ < maxValue))
  ...
  @Test def indexSequence(): Unit =
    ...
    val arrayBuffer = measures("Array Buffer")(range.to(mutable.ArrayBuffer))(_.last)(_.appended(value))(_.dropWhile(_ < maxValue))
