...
//    // e simile per gli altri
//    assertEquals(Some((9.0 + 6.0) / 2, 0.01), cr.averageWeightedFinalScoreMap().get(2))
//    assertEquals(Some((0.9 + 1.6) / 2, 0.01), cr.averageWeightedFinalScoreMap().get(3))
//    assertEquals(Some((3.6 + 5.6 + 5.6) / 3, 0.01), cr.averageWeightedFinalScoreMap().get(4))
//    assertEquals(Some((6.0 + 7.0) / 2, 0.01), cr.averageWeightedFinalScoreMap().get(5))
